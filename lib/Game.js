...
Game.prototype.checkForSunkShip = function(board, shipIndex) {
  ...
  if (id == this.board1.id) {
    if (this.board2.grid[row][col].state == CellStates.SHIP) {
      ...
      if (this.board2.ships[shipIndex].timesHit == this.board2.ships[shipIndex].len) {
        ...
        // this.clients.get(ids[0]).emit('you-sunk-a-ship', {
        //   ship: this.board2.ships[shipIndex]
        // })
        // this.clients.get(ids[1]).emit('your-ship-got-sunk', {
        //   ship: this.board2.ships[shipIndex]
        // })
    ...
    if (this.board1.grid[row][col].state == CellStates.SHIP) {
      ...
      if (this.board1.ships[shipIndex].timesHit == this.board1.ships[shipIndex].len) {
        ...
        // this.clients.get(ids[1]).emit('you-sunk-a-ship', {
        //   ship: this.board1.ships[shipIndex]
        // })
        // this.clients.get(ids[0]).emit('your-ship-got-sunk', {
        //   ship: this.board1.ships[shipIndex]
        // })
